...
struct ImGuiContext
{
    ...
    ImGuiWindow*            CurrentChildWindow;                 // Child window being drawn into
...
namespace ImGui
{
    ...
    IMGUI_API bool          BeginChildEx(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags, bool drawname = false);
